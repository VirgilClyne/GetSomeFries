...
if ($.getjson("Neurogram")) {
	...
	$.Dualsub.Netflix = $.getjson("Neurogram")?.Dualsub?.Netflix ?? $.Dualsub.Netflix;
...
// Argument Function Supported
    ...
    $.argument = {
        Netflix: {
            Settings: {
                type: arg?.type ?? "Google", // Google, DeepL, Disable
    ...
    $.Dualsub.Netflix = Object.assign($.Dualsub,$.argument).Netflix
...
const Settings = $.Dualsub.Settings[Platform]
$.log(`🚧 ${$.name}, Enviroment调试信息`, `Settings内容: ${JSON.stringify($.Dualsub.Settings[Platform])}`, "");
var Cache = $.Dualsub.Cache[Platform]
$.log(`🚧 ${$.name}, Enviroment调试信息`, `Cache内容: ${JSON.stringify($.Dualsub.Cache[Platform])}`, "");
...
/***************** Netflix Subtitle *****************/
if (Platform == "Netflix") {
    if (Settings.type == "Google") machine_subtitles("Google")
